wordLst=["armand ortiz", "baseball", "homeless", "zipper", "gnarly", "janitor", "computer", "batman", "hereditary", "vampire", "mike wazowski", "python", "barack obama", "calculus", "football player", "yoda", "progress report", "lady gaga", "abraham lincoln", "russell wilson", "defenestrate", "butthole", "airpods", "cheese", "calendar", "hypothesis", "seattle", "juxtaposition", "snack attack", "sicko mode", "axiom", "askew", "swimming pool"]
